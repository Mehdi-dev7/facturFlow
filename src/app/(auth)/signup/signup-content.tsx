...
function GoogleIcon() {
	return (
		<svg className="group-hover:rotate-180 transition-transform duration-500" width="26" height="26" viewBox="0 0 24 24" aria-hidden="true">
...
function GitHubIcon() {
	return (
		<svg className="group-hover:rotate-180 transition-transform duration-500" width="26" height="26" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
