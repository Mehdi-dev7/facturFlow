// Twitter Card image — même design que l'og:image
// Next.js la servira automatiquement sous /twitter-image
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            ...
            <span style={{ color: "white", fontSize: 56, fontWeight: 700, letterSpacing: "-1px" }}>
              FacturNow
            </span>
          </div>
          <div
