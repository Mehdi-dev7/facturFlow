...
export function UpgradeModal({ open, onClose, feature }: UpgradeModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) onClose(); }}>
      <DialogContent className="sm:max-w-md bg-linear-to-b from-violet-50 via-white to-white dark:from-[#2a2254] dark:via-[#1e1845] dark:to-[#1a1438] border border-primary/20 dark:border-violet-400/30 shadow-xl dark:shadow-violet-950/50 rounded-2xl">
        {/* Icône */}
