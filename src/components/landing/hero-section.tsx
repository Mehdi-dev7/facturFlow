...
import { CheckCircle2, ArrowRight, FileText, CreditCard, TrendingUp, Zap } from "lucide-react"
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-slate-50 via-white to-slate-50">
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(79, 70, 229, 0.3), rgba(99, 102, 241, 0.4), rgba(99, 102, 241, 0.3), rgba(6, 182, 212, 0.15))'
          }}
        />
      </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-bold font-heading text-slate-900">Tableau de bord</h3>
                  <div className="flex items-center space-x-2">
                    <div className="h-2 w-2 rounded-full bg-green-500 animate-pulse" />
                    <span className="text-xs text-slate-500 font-ui">En direct</span>
                  </div>
                </div>

                {/* Stats */}
                <div className="grid grid-cols-3 gap-4">
                  <div className="p-4 rounded-xl" style={{ background: 'linear-gradient(to bottom right, rgba(79, 70, 229, 0.1), rgba(99, 102, 241, 0.1))' }}>
                    <FileText className="h-6 w-6 mb-2" style={{ color: 'rgb(79, 70, 229)' }} />
                    <p className="text-2xl font-bold font-heading text-slate-900">24</p>
                    <p className="text-xs text-slate-600 font-ui">Factures</p>
                  </div>
                  <div className="p-4 rounded-xl" style={{ background: 'linear-gradient(to bottom right, rgb(240, 253, 244), rgb(209, 250, 229))' }}>
                    <TrendingUp className="h-6 w-6 text-green-600 mb-2" />
                    <p className="text-2xl font-bold font-heading text-slate-900">18</p>
                    <p className="text-xs text-slate-600 font-ui">Payées</p>
                  </div>
                  <div className="p-4 rounded-xl" style={{ background: 'linear-gradient(to bottom right, rgb(255, 247, 237), rgb(254, 243, 199))' }}>
                    <CreditCard className="h-6 w-6 text-orange-600 mb-2" />
                    <p className="text-2xl font-bold font-heading text-slate-900">6</p>
                ...
                <div className="border border-slate-200 rounded-lg p-4 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-semibold text-slate-900 font-ui">Facture #INV-2025-042</span>
                    <span className="px-2 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded-full font-ui">
                      Payée
                    </span>
                  </div>
                  <p className="text-xs text-slate-500">Client: Entreprise ABC</p>
                  <p className="text-lg font-bold text-slate-900 font-heading">2 450,00 €</p>
                </div>
              </div>
              ...
              <div 
                ...
                style={{ background: 'linear-gradient(to bottom right, rgb(250, 204, 21), rgb(249, 115, 22))' }}
              >
