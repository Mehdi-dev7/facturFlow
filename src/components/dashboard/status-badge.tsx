...
export type InvoiceStatus = "payée" | "impayée" | "en attente";
export type QuoteStatus = "accepté" | "refusé" | "brouillon" | "envoyé" | "expiré" | "en attente";
...
interface StatusStyle {
  ...
  border: string;
  label: string;
  icon: "check" | "cross" | "dot" | "send" | "expired" | "draft" | null;
}
