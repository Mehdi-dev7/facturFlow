...
function StatusIcon({ icon, cfg }: { icon: StatusStyle["icon"]; cfg: StatusStyle }) {
  switch (icon) {
    case "check":
      return (
        <svg className="w-2 h-2 lg:w-3 lg:h-3 animate-pulse" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    ...
    case "dot":
      return <span className={`h-1.5 w-1.5 lg:h-2 lg:w-2 shrink-0 rounded-full ${cfg.dot}`} />;
    case "send":
      return (
        <svg className="w-2 h-2 lg:w-3 lg:h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    case "bell":
      return (
        <svg className="w-2 h-2 lg:w-3 lg:h-3 animate-pulse" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export function StatusBadge({ status }: { status: AllStatus }) {
  ...
  return (
    <span className={`inline-flex items-center gap-0.5 lg:gap-1.5 rounded-full px-1.5 py-0.5 lg:px-3 lg:py-1.5 text-[9px] lg:text-xs font-bold ${cfg.bg} ${cfg.text} ${cfg.border}`}>
