...
import type { QuoteFormData, CompanyInfo } from "@/lib/validations/quote";
...
export function QuoteStepper({
	...
	const validateStep = useCallback(
		async (currentStep: number) => {
			const fieldsMap: Record<number, (keyof QuoteFormData)[]> = {
				1: ["clientId", "date", "validUntil"],
				2: ["lines"],
				3: [], // notes et acompte sont optionnels
			};
			...
			<div className="border-t border-slate-200 dark:border-violet-500/20 px-4 pt-3 pb-2 bg-white/50 dark:bg-[#1a1438]/50 backdrop-blur-sm space-y-2">
				...
				<div className="flex justify-center">
					<Sheet>
						...
						<SheetContent side="bottom" className="h-[80vh] overflow-y-auto bg-linear-to-b from-emerald-50 via-white to-white dark:from-[#1e1b4b] dark:via-[#1a1438] dark:to-[#1a1438]">
							<SheetHeader>
